...
\begin{document}
	\section*{\vspace{-1.5cm}\begin{center}\normalsize\normalfont{Homework 6, Formal Methods in Mathematics\\University Utrecht, \today\\AKS primality group}\end{center}}
	\vspace{-\baselineskip}\noindent \rule{\textwidth}{0.025cm}\vspace{\parskip}
	For the final project, we would like to explore the AKS primality test in Lean.
	
	Number theory, AKS primality test, modulo/cyclic groups
	(If timewise convenient, could also try to prove the time complexity)
